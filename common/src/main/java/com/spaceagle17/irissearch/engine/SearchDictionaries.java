...
public final class SearchDictionaries {
    ...
    private static final List<Set<String>> SYNONYM_GROUPS = List.of(
        ...
        Set.of("cas", "contrast adaptive sharpening", "sharpening", "sharpen", "sharpness"),
        Set.of("tonemap", "tonemapping", "tone mapping", "tone map", "aces", "agx", "reinhard"),
        Set.of("colorgrading", "color grading", "colour grading", "color correction", "colour correction"),
        Set.of("vibrance", "vibrancy", "saturation", "colorfulness"),
        Set.of("autoexposure", "auto exposure", "auto-exposure", "eye adaptation", "eye adjustment", "light adaptation"),
        Set.of("purkinje", "purkinje effect", "purkinje shift", "night desaturation"),
        Set.of("lensflare", "lens flare", "lens flares"),
        Set.of("filmgrain", "film grain", "grain"),
        Set.of("aurora", "northern lights", "aurora borealis", "polar lights"),
        Set.of("stars", "starfield", "star field", "milky way", "milkyway", "galaxy"),
        Set.of("volumetricclouds", "volumetric clouds", "volumetric cloud", "3d clouds"),
        Set.of("atmosphericscattering", "atmospheric scattering", "atmosphere", "rayleigh scattering", "rayleigh", "mie scattering"),
        Set.of("normalmap", "normal map", "normal mapping", "bumpmap", "bump map", "bump mapping"),
        Set.of("specular", "specularmap", "specular map", "specular highlights", "specular highlight", "reflectivity"),
        Set.of("labpbr", "lab pbr", "oldpbr", "old pbr", "seus pbr", "material format"),
        Set.of("emissive", "emission", "emissives", "emissive blocks", "glowing blocks"),
